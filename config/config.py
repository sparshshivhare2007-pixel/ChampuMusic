...
BOT_USERNAME = getenv("BOT_USERNAME", "Sreexmusicbot")
...
EXTRA_PLUGINS_REPO = getenv(
    "EXTRA_PLUGINS_REPO",
    "https://github.com/sparshshivhare2007-pixel/Extra-Plugin",
)
...
# Your User ID.
OWNER_ID = list(
    map(int, getenv("OWNER_ID", "8321938136").split())
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/sparshshivhare2007-pixel/ChampuMusic",
)
...
SUPPORT_CHANNEL = getenv(
    "SUPPORT_CHANNEL", "https://t.me/internalxfeelings"
)  # Example:- https://t.me/SHIMZUKA_NETWORK
SUPPORT_GROUP = getenv(
    "SUPPORT_GROUP", "https://t.me/Sanginixbots"
)  # Example:- https://t.me/SHIMZUKA_SUPPORT
...
GITHUB_REPO = getenv("GITHUB_REPO", "https://github.com/sparshshivhare2007-pixel/ChampuMusic")
...
START_IMG_URL = getenv(
    "START_IMG_URL",
    "https://files.catbox.moe/fa1bwx.jpg",
)
...
if PING_IMG_URL:
    if PING_IMG_URL != "https://files.catbox.moe/fa1bwx.jpg":
...
if PLAYLIST_IMG_URL:
    if PLAYLIST_IMG_URL != "https://files.catbox.moe/fa1bwx.jpg":
...
if GLOBAL_IMG_URL:
    if GLOBAL_IMG_URL != "https://files.catbox.moe/fa1bwx.jpg":
...
if STATS_IMG_URL:
    if STATS_IMG_URL != "https://files.catbox.moe/fa1bwx.jpg":
...
if TELEGRAM_AUDIO_URL:
    if TELEGRAM_AUDIO_URL != "https://files.catbox.moe/fa1bwx.jpg":
...
if STREAM_IMG_URL:
    if STREAM_IMG_URL != "https://files.catbox.moe/fa1bwx.jpg":
...
if SOUNCLOUD_IMG_URL:
    if SOUNCLOUD_IMG_URL != "https://files.catbox.moe/fa1bwx.jpg":
...
if YOUTUBE_IMG_URL:
    if YOUTUBE_IMG_URL != "https://files.catbox.moe/fa1bwx.jpg":
...
if TELEGRAM_VIDEO_URL:
    if TELEGRAM_VIDEO_URL != "https://files.catbox.moe/fa1bwx.jpg":
